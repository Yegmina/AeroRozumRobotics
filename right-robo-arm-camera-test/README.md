# AeroRozum Robotics Right Camera Feed

This project accesses the camera feed from the right robo arm through its unique
...
the reusable wrapper opens the right USB camera by its DirectShow device path
